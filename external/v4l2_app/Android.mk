...
# LOCAL_MODULE_TAGS := debug
LOCAL_MODULE_PATH := $(TARGET_OUT_OPTIONAL_EXECUTABLES)/v4l2
# LOCAL_C_INCLUDES := $(LOCAL_PATH)/ffmpeg_v4.0/include
LOCAL_CFLAGS := -I$(LOCAL_PATH)/ffmpeg_v4.0/include

LOCAL_LDFLAGS := -L$(LOCAL_PATH)/ffmpeg_v4.0/lib \
...
LOCAL_MODULE_PATH := $(TARGET_OUT_OPTIONAL_EXECUTABLES)/v4l2
# LOCAL_C_INCLUDES := $(LOCAL_PATH)/ffmpeg_v4.0/include
LOCAL_CFLAGS := -I$(LOCAL_PATH)/ffmpeg_v4.0/include -g
